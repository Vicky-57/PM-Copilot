...
class Config:
    ...
    SARVAM_API_KEY: str = os.getenv("SARVAM_API_KEY", os.getenv("VITE_SARVAM_API_KEY", ""))
    ...
    def validate(cls):
        ...
        if not cls.GROQ_API_KEY and not cls.GEMINI_API_KEY and not cls.SARVAM_API_KEY:
            # We don't crash, but warn so the user knows they need to configure it
            print("WARNING: No LLM API key found. Please set SARVAM_API_KEY, GEMINI_API_KEY, or GROQ_API_KEY in your .env file.")
